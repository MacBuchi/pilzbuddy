...
void registerMapDataLicense() {
  LicenseRegistry.addLicense(() async* {
    ...
    yield const LicenseEntryWithLineBreaks(
      ...
      'Melder angegeben hat, für Deutschland, Österreich, die Schweiz, '
      'Liechtenstein und die italienischen Alpen mit Südtirol. Namen der '
      'Melder werden nicht mitgeliefert.\n'
      'https://www.gbif.org\n\n'
