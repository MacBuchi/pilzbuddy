      ...
      child: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            // Nur wenn die Auswahl etwas bewirkt: Ohne Ampel-Vorschau
            // gibt es weder Fläche noch Nachlauf, und ohne
            // Fundorte-Ebene keine Scheiben — die Chips hätten dann
            // nichts zu tun, und das Blatt ist knapp. Die Artenliste hat
            // hier seit #414 weniger als eine Bildschirmzeile; ein
            // wirkungsloser Block nähme ihr die nächste. Dieselben Chips
            // stehen seit 1.155.0 auch im Fundorte-Blatt.
            if (ref.watch(ampelPreviewEnabledProvider) ||
                ref.watch(gbifLayerEnabledProvider))
              // EINE Zeile auf 412 dp: Ein zweizeiliger Satz ließ das
              // Blatt auf dem Telefon um 5 px überlaufen (gemessen im
              // Flow-Test).
              const AmpelClassChips(
                intro: 'Gruppen für Ampel und Fundorte — auch auf der Fläche:',
              ),
