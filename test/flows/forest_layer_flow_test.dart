...
void main() {
  ...
  testWidgets('Waldebene aus nimmt die Pilzwetter-Ampel mit', (tester) async {
    // Die Ampel leuchtet IN den Waben. Bliebe ihr Schalter an, während
    // die Waldebene aus ist, behauptete das Regen-Blatt etwas, das die
    // Karte nicht zeigt.
