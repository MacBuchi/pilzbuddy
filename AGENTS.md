...
- **Ein Statusleisten-Symbol ist NUR sein Alphakanal** (#331, seit
  ...
  Von der Designsprache (`.Codex/skills/pilz-designer/`) überlebt hier
...
- **Regen auf der Karte** (#156, seit 1.45.0): vier Ebenen hinter einem
  ...
  `test/privacy_policy_test.dart` erzwingt seither die AGENTS.md-Regel
...
- Issue-Triage (`.github/workflows/Codex-issue-triage.yml`): Codex analysiert
  ...
  Freigabe-Kommentar `@Codex …` (Codex.yml, Branch + PR, Merge manuell).
  ...
  Codex GitHub App (github.com/apps/Codex). Bot-Issues werden per workflow_dispatch triagiert
  (GITHUB_TOKEN-Events triggern keine Folge-Workflows). Temporär aus:
  `gh workflow disable "Codex Issue Triage"`.
