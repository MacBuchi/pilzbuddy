...
**Entschieden am 2026-09-12** (`docs/pilzampel-artenfenster-messung.md`): Die Kontrolle ist an ihrer **Auswahl** gescheitert, nicht am Modell.

Je Art wurde ein Temperaturoptimum angepasst — auf den Jahren bis 2018, geprüft auf 2019–2025, mit vorab festgelegter Vorhersage für den Austernseitling. Sie ist eingetroffen: Sein Fenster liegt bei **−1,8 °C**, und seine AUC steigt von Zufallsniveau (0,482) auf **0,614** (Differenz +0,131 [+0,044, +0,207]). Über den ganzen Bereich fällt seine Trennschärfe monoton mit der Wärme — bei 25 °C liegt sie mit 0,396 **unter** Zufall, dort sagt Wärme also Abwesenheit voraus. Hallimasch (10,8 °C) und Stockschwämmchen (12,5 °C) teilen dagegen schlicht das Herbstfenster; als Gegenprobe waren sie untauglich.

**Damit ist die Lesart „das Modell misst allgemeines Pilzwetter" widerlegt.** Es wirkt artspezifisch — man muss nur Arten vergleichen, die sich wirklich unterscheiden.

**Eine Ampel je ART bleibt trotzdem unbegründet**, und zwar aus dem Gegenteil des alten Grundes: Die sechs Mykorrhiza-Arten liegen zwischen 12,5 und 14,5 °C, und bei jeder von ihnen enthält der Vertrauensbereich der Differenz die Null. Ein eigenes Fenster bringt ihnen **nichts**. Was die Daten stützen, ist eine Unterscheidung nach **Typ** — Herbst-Mykorrhiza (13 °C, wie ausgeliefert), warm (Pfifferling, 16–19 °C, noch unbestätigt) und kalt (Austernseitling). Genau das tut die App heute schon, indem sie für nicht validierte Arten grau bleibt; neu ist, dass diese Grenze jetzt Zahlen hinter sich hat.
